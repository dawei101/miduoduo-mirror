define(function(require, exports) {
    //线上环境去掉下面这句
    miduoduo.accessToken = "JRStEeKM4NFVvw5Ovy-I2gP3MEO1kK2A_1435923082";
    //通用版本
    ...
    function gen(partUrl) {
        partUrl.indexOf("?") > -1 ? partUrl += "&access_token=" + miduoduo.accessToken : partUrl += "?access_token=" + miduoduo.accessToken;
