      ...
      <div class="col-sm-12 col-md-2 col-lg-2 padding-0" style="background:#f00">
        <div class="qiye-left">
          ...
          <dl class="pitch-current">
            ...
            <dd class="current"><a href="#">企业认证</a></dd>
          </dl>
        </div>
      </div>
        ...
        <form>
          <ul class="tianxie-box" style="border:none">
              ...
              <li>
                ...
                <div class="pull-left right-box">
                  <div class="form-group">
                      <label class="shangchuan" for="license">上传图片</label>
                      <input type="file" id="license" style="display:none;"><span class="pull-rigth"><em class="em-rad">*</em>提交照片需要注意以下几点</span>
                   </div>
                  <div class="tishi">
