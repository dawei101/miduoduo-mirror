              ...
              <ul class="tianxie-box">
                <li>
                  ...
                  <div class="pull-left right-box">
                    <input type="text" placeholder="请简述职位标题，字数控制在20字内">
                  </div>
                </li>
                <li>
                ...
                <li>
                  ...
                  <div class="pull-left right-box div">
                    <div class="riqi">
                      <input type="text" readonly style="width: 200px" name="reservation" class="reservation"   value="选择您的起始日期" />
                      <div class="nice-select times" name="nice-select">
                        <input type="text" value="13:00" ><i class="iconfont">&#xe60d;</i>
                        <ul>
                ...
                <li>
                  ...
                  <div class="pull-left right-box">
                    <input type="text" readonly style="width: 200px" name="birthday" id="birthday" value="2013-06-12" />
                  </div>
                </li>
                <li>
                ...
                <li>
                  ...
                  <div class="pull-left right-box input-z">
                    ...
                    <div class="nice-select pull-left ma-right" name="nice-select">
                      <input type="text" class="text-center" value="性别" >
                      <i class="iconfont">&#xe60d;</i>
                      <ul>
                        <li>男女不限</li>
                        <li>男</li>
